...
class CollectionViewDataSource: ScrollViewDataSource  {
    ...
    init (items : Array<Any>?  , collectionView : UICollectionView? , cellIdentifier : String? ,cellHeight : CGFloat , cellWidth : CGFloat ,minimumLineSpacing : CGFloat ,minimumInteritemSpacing : CGFloat)  {
